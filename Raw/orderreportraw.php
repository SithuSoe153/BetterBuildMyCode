...
<body>
    ...
    <form action="orderreportraw.php" method="post">
        <fieldset>
                ...
                <tbody>
                    ...
                    for ($i = 0; $i < $count; $i++) {
                        ...
                        echo "<td> 
                            ...
                            <a href='orderdetail.php?oid=$OrderID' style='color:red'>Detail</a> |
                            <a href='orderaccept.php?oid=$OrderID' style='color:red'>Accept</a> |
